import type Wallet from '../../safe-wallet-link';
import {
...
export abstract class BaseSafecoinWalletAdapter extends BaseMessageSignerWalletAdapter {
    protected _provider: string | SafecoinWallet | undefined;
    ...
    constructor({ provider, network = WalletAdapterNetwork.Mainnet, timeout = 10000 }: SafecoinWalletAdapterConfig = {}) {
        super();
    ...
    async connect(): Promise<void> {
        try {
            ...
            let SolWalletAdapter: typeof import('../../safe-wallet-link');
            try {
                SolWalletAdapter = await import('../../safe-wallet-link');
            } catch (error: any) {
